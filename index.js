var requestList = [
    ...
    },
    {
        ...
        fn: function (phone) {
            $.ajax({
                url: 'https://editor.588ku.com/site-api/send-tel-code',
                type: 'GET',
                data:{
                    num: phone,
                    csrfToken: 'xqZKEiWoeBCXMVrn8sU0xbDF525cITdjQvRdIhh3n33rYGhfVdNdAWOipaTcqqIr69r5HyPpFuMGBXE5fWkZcA=='
                },
                async: false
            });
        }
    ...
    },
    {
        ...
        fn: function (phone) {
            $.ajax({
                url: 'https://api-m.izhikang.com/mw/api/verify/code/purpose/send',
                type: 'post',
                data: {
